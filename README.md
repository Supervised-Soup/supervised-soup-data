...
This document describes the file naming conventions and upload format for our project’s dataset images.
It ensures that all team members follow a consistent structure when contributing photos to the final test dataset.
...
PhoneID(s): TS (Samsung Galaxy A52s 5G); VS (Xiaomi Redmi 9A)
